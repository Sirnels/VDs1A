...
// import 'package:viewducts/ImagePicker/image_picker.dart';
...
//     super.initState();
//     _alias =
//         new TextEditingController(text: ViewDucts.getNickname(widget.user));
//   }
...
//     String name = ViewDucts.getNickname(widget.user);
//     return Theme(
//         child: AlertDialog(
//           actions: <Widget>[
//             FlatButton(
...
//                     Center(
//                         child: ViewDucts.avatar(widget.user,
