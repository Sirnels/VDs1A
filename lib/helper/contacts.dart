...
// import 'package:viewducts/helper/testing_DataModel.dart';
// import 'package:viewducts/helper/testing_chart.dart';
// import 'package:viewducts/helper/testing_chat_controller.dart';
// import 'package:viewducts/helper/testing_pre_chat.dart';
// import 'package:viewducts/helper/utility.dart';
// import 'package:viewducts/page/testing_settings.dart';
...
//     // ViewDucts.checkAndRequestPermission(PermissionGroup.contacts).then((res) {
//     //   if (res) {
...
//           autofocus: true,
//           style: TextStyle(color: viewductWhite),
//           controller: _filter,
//           decoration: new InputDecoration(
//               hintText: 'Search ', hintStyle: TextStyle(color: viewductWhite)),
//         );
//       } else {
...
//     super.build(context);
//     return ViewDucts.getNTPWrappedWidget(Provider.of(context)<ChatState>(
//         model: widget.model,
//         child:
//             Provider.of(context)<ChatState>(builder: (context, child, model) {
//           return Scaffold(
...
//                                       radius: 22.5,
//                                       child: Text(
//                                           ViewDucts.getInitials(user.value))),
...
//                                             type:
//                                                 ViewDucts.getAuthenticationType(
