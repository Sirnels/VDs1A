...
class VductsEarningsPage extends StatefulWidget {
  const VductsEarningsPage({Key? key}) : super(key: key);

  @override
  _VductsEarningsPageState createState() => _VductsEarningsPageState();
}

class _VductsEarningsPageState extends State<VductsEarningsPage> {
  @override
