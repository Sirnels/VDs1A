...
final TextStyle selectedTabText = TextStyle(
    fontWeight: FontWeight.w800, fontSize: 16, color: Colors.teal[500]);

final TextStyle defaultTabText = TextStyle(
    fontWeight: FontWeight.w500, fontSize: 13, color: Colors.blueGrey[500]);
